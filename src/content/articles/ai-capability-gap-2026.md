...
readingTime: 10
faq:
  - q: "全球 AI 使用分布圖顯示的數據準確嗎？"
    a: "這張圖來自 John Crowley 的 Thayer Method 研究，基於全球 81 億人口推估。雖然精確數字可能有誤差，但趨勢具參考價值：84% 從未使用 AI，16% 用過免費聊天機器人，只有約 0.05% 使用 AI 程式開發工具。"
  - q: "台灣的 AI 採用率真的比全球平均更高嗎？"
    a: "是的。台灣有 90-110 萬科技從業人口，加上高密度的半導體與電子產業，AI 滲透率確實高於全球平均。估計台灣約 70% 從未使用 AI（全球 84%），約 0.1% 使用 AI 開發工具（全球 0.04%）。"
  - q: "什麼是 AI 能力的 K 型分化？"
    a: "類似 COVID 後的 K 型復甦，AI 能力差距正在擴大。會使用 AI 的人能力倍增，不使用的人相對落後，中間層被掏空。這不只是技術問題，而是思考能力的根本差異。"
  - q: "現在開始學 AI 還來得及嗎？"
    a: "來得及，但要快。AI 發展不是線性的，而是加速度本身還在加速。晚一步進場，看到的可能是不同版本的世界。建議從付費使用 AI 工具開始，逐步整合進工作流程。"
# === AI / Machine 專用欄位 ===
