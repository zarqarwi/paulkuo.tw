...
subtitle: "Transync AI 之外的選項：用 AI 協作自建即時會議翻譯，成本降到 1/10"
description: "付了三年 Good Tape 訂閱費、評估過 Transync AI 之後，一個不會寫程式的人用 AI 協作做出了即時多語會議翻譯工具，每場會議成本台幣 16 元。記錄從痛點到實作的完整過程，以及這個過程揭示的 AI 素養本質。"
abstract: |
