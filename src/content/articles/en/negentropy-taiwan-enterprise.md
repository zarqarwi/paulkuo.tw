...
subtitle: "Don't Choose Sides Politically—Choose Sides Based on Order"
description: "Entropy represents chaos and decay, while negentropy is order and vitality. Business decisions are essentially about fighting entropy increase. From an anti-entropy historical perspective, the US-China competition is a race of entropy reduction engineering. Taiwan enterprises should not choose sides politically, but should choose sides based on order—approaching stable institutional centers of negentropy while distancing themselves from chaotic entropy flows."
abstract: |
  Every time I chat with business owners about US-China relations, the conversation almost always leads to the same dead end: "Should we rely on America or China?" I think this question itself is wrong. Because it treats geopolitics as a loyalty test of choosing sides, rather than a strategic judgment. I've used a different framework to think about this—entropy and negentropy. Schrödinger pointed out in 1944 that the essence of life is consuming negentropy and fighting chaos. The same applies to enterprises. This piece starts from the physics concept of entropy to discuss why Taiwan enterprises should not choose sides politically, but should "choose sides based on order"—approaching systems that are creating order while distancing themselves from systems that are creating chaos.
date: 2025-04-29
updated: 2026-03-03
pillar: ai
tags:
