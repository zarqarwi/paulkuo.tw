...
description: "Goal-oriented thinking is a trap. Kenneth Stanley and Joel Lehman's 'Why Greatness Cannot be Planned' reveals a counterintuitive truth: from microwaves to GPUs, from Mozart to Kodak, all world-changing discoveries were born not from pursuing predetermined objectives, but from following interests. Paul's entrepreneurial journey—from iShelly to nvesto to our AI platform—perfectly validates the Stepping Stones model."
abstract: |
  Goal-oriented planning is the enemy of innovation. This article introduces the core theory of Kenneth Stanley & Joel Lehman's "Why Greatness Cannot be Planned": the Stepping Stones model and Novelty Search algorithm. From historical cases (Wright brothers, microwave ovens, GPUs) to reflections on national policy, and Paul Kuo's twenty years of entrepreneurial practice as proof, it reveals an uncomfortable truth: what truly changes the world are often those steps considered "furthest from the goal."
date: 2025-06-27
pillar: startup
tags:
  - Entrepreneurship
...
draft: false
readingTime: 6
thesis: "Greatness is not planned, but discovered in the process of pursuing what's interesting and wandering off course. This changes our entire conception of entrepreneurship, education, and organizational governance."
...
related_entities:
  ...
  - name: Stepping Stones Model
    type: Concept
reading_context: |
  For entrepreneurs, leaders, and anyone who feels that "five-year plans are completely unrealistic."
---
