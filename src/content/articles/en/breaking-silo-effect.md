---
title: "Breaking Through Organizational Rigidity: Business Development as Silo-Breaking"
subtitle: "The root of organizational rigidity isn't division of labor—it's the breakdown of information flow"
description: "Organizational rigidity stems from information opacity caused by excessive division of labor. True business development is not just sales, but serving as a translator across boundaries, requiring coordination of various gaps from a higher dimension. The silo effect isn't solved by tearing down walls, but by having people who enable information flow."
abstract: |
  Anyone who has done B2B in Taiwan has probably encountered this scenario: negotiating a partnership with a company, holding dozens of meetings, facing different people each time, but things never move forward. This is the daily reality of the silo effect. After years in business development, my deepest realization is: silos aren't dismantled through organizational restructuring, but through translators who can navigate between different silos. This piece explores why the core competency of business development isn't sales, but the ability to enable information flow within and across organizations—and why this role has become even more important in the AI era.
date: 2018-01-26
updated: 2026-03-03
pillar: startup
tags:
...
This cross-dimensional ability is essentially what I've been calling [cross-domain connection](/articles/post-code-era-taste). Not knowing everything, but knowing enough to translate between different professional languages.
