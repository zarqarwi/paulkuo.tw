...
What truly makes the Baishatun Mazu Pilgrimage moving is the entire set of practices—walking, waiting, departure, receiving fire, return—that [transforms faith into a bodily experienceable order](/articles/faith-collapse-rebuild/). The distance is only the surface. The ritual brings people into a world with symbolic depth.
...
But these are all paper figures. The real question is: how do we let everyone know how far they've walked and how much they've contributed? How do we connect "doing good" and "carbon reduction," making these actions visible?
...
But we hope the Baishatun pilgrimage can change this impression. When you put carbon footprint tracking into an activity with 400,000 participants, sustainability can be personal experience with numbers—"I walked fifteen kilometers today, corresponding to approximately 3.15 kilograms of carbon emission reduction"—not just text in reports. Faith provides motivation, technology provides measurement, and the influence generated by combining the two is a new attempt and creation. Just this kind of integration has innovative significance.
...
The role of [SSBTi](https://www.ssbti.org) in this project is precisely this: providing methodological reference foundations and frameworks, turning data from an engineer's calculations into behavioral indicators with methodological foundations that can be continuously optimized.
...
This time, what we did was simply try to connect and integrate. Using technology to translate those originally invisible footsteps into language that contemporary society can understand. This time, the footsteps of 400,000 people left real numbers behind. Carbon reduction got its own name, faith got a visible shape.
