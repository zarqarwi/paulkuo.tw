...
draft: false
readingTime: 7
thesis: "When AI-driven supply chains evolve from competitive advantage to infrastructure, Taiwanese companies face not a technology gap but a trust gap—whether organizations are willing to let AI participate in decision-making, not just generate reports."
abstract: "JD's AI supply chain has evolved from internal tool to external platform: three-layer capability stack (prediction, explainability, logistics optimization), Logistics Brain 2.0 upgrade, JD Industrial IPO, international logistics brand expansion. Stanford's Triple-A academic paper certification marks this model's elevation from enterprise case to industry template. The lesson for Taiwanese companies isn't imitation, but understanding the trend toward supply chain capability-as-a-service."
domain_bridge: "Starting from nine months of tracking the JD Stanford case, connecting academic paper certification, three-layer AI supply chain capabilities, and platform-based business models to structural challenges in Taiwan's manufacturing and service industries."
