---
title: "Beyond Man-Days: A New Framework for Measuring AI Collaboration"
subtitle: "AI Collaboration Portfolio × Five Dimensions: From Measuring Attendance to Measuring Value Creation"
description: "When 40 minutes of cognitive input produces 15 person-days of output, what does 'person-day' even measure? This paper proposes the AI Collaboration Portfolio — a five-dimension framework (Command / Delivery / Leverage / Quality / Influence) with a three-layer anti-gaming evidence architecture — to fill the gap in individual AI productivity measurement."
abstract: |
  Everyone is measuring AI literacy. No one is measuring individual AI productivity. Anthropic's Economic Index confirms a 0.92 correlation between prompt quality and output quality, and 12x acceleration for college-level tasks — but these insights remain at the macro level. This paper proposes the AI Collaboration Portfolio, a five-dimension framework that attempts, for the first time, to measure AI collaboration capability at the individual level, based on performance, with verifiable evidence. Includes a full proof-of-concept using the author's own data.
date: 2026-04-08
updated: 2026-04-08
pillar: ai
tags:
...
readingTime: 15
# === AI / Machine fields ===
thesis: "Person-days measure the passage of time, not value creation — the AI Collaboration Portfolio is the first system to measure AI collaboration productivity at the individual level, based on performance, with verifiable evidence."
domain_bridge: "AI productivity measurement × software engineering methodology × human resources evaluation × open-source verification"
confidence: high
content_type: essay
related_entities:
  - name: Fred Brooks
  ...
  - name: Paul Kuo
    type: Person
reading_context: |
  For tech leaders, HR professionals, independent developers, and knowledge workers interested in how AI-era talent evaluation needs to change — and who want a verifiable way to demonstrate their own AI collaboration capabilities.
---

> **TL;DR** — Person-days measure attendance, not value creation. This paper proposes the AI Collaboration Portfolio — a five-dimension framework (Command / Delivery / Leverage / Quality / Influence) with automated extraction, structured self-assessment, and AI-assisted verification — to fill the gap in individual AI productivity measurement. Includes a full proof-of-concept. → [Try the tool](https://paulkuo.tw/tools/ai-collab-portfolio/)
...
The inadequacy of time-based productivity metrics is not a new observation. In 1975, computer scientist [Fred Brooks](https://en.wikipedia.org/wiki/Fred_Brooks) published [*The Mythical Man-Month*](https://en.wikipedia.org/wiki/The_Mythical_Man-Month), arguing that the person-month — the assumption that labor and time are freely interchangeable — was a dangerous fiction. His core insight: adding people to a late project makes it later, because the communication overhead required to coordinate additional contributors consumes more time than their labor saves.
...
In February 2026, [the US Department of Labor](https://www.dol.gov/) released its AI Literacy Framework, defining five content areas that workers need to be considered AI literate. [The UK's Alan Turing Institute](https://www.turing.ac.uk/) released Version 3 of its AI Skills for Business Competency Framework in late 2025. [UNESCO](https://www.unesco.org/) has published AI competency frameworks for both students and teachers. In academia, researchers have developed and validated scales for Collaborative AI Literacy and Collaborative AI Metacognition.
...
Everyone is measuring AI literacy. No one is measuring AI productivity at the individual level. This paper proposes a framework to fill that gap. It continues a thread from my earlier analysis of [the AI capability gap](/articles/ai-capability-gap-2026) — that piece documented the gap's existence; this one proposes how to quantify it.
...
This is methodologically valid. A framework designer naturally selects evidence that flatters the framework. The response is not to deny this bias but to make it structurally irrelevant. Every claim in the proof of concept below is independently verifiable through public URLs, GitHub repositories, and third-party analytics. The value of this demonstration is not statistical — it is engineering. It provides a complete, inspectable, reproducible blueprint that others can run against their own data. Think of it less as a clinical trial and more as an open-source release: the initial version inevitably reflects the creator's context and biases. Its worth will be determined by whether the community finds it useful enough to build upon.
