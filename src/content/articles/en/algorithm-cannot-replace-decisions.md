---
title: "The Weight Algorithms Cannot Replace: Why We Shouldn't Become Scientism Believers?"
subtitle: "Outsourcing decisions to algorithms isn't a triumph of rationality—it's a shortcut to escape pain"
description: "Platforms and data can reduce information asymmetry, but decisions still require the human brain's leap-based thinking. Any platform claiming to make decisions for you is either naive or deceptive. In today's era of more powerful AI, this warning deserves to be heard more than it did a decade ago."
abstract: |
  When I wrote this article in 2017, AI didn't have today's aura. But even then, a certain faith was spreading through Silicon Valley and Taiwan's startup circles: as long as you have enough data and good enough models, systems can make decisions for you. I called this faith "scientism." Looking back seven years later, AI capabilities have indeed made tremendous leaps, but the essence of decision-making hasn't changed—it remains a painful process full of ambiguity, duality, and uncertainty. This piece aims to deconstruct: why is there an unbridgeable chasm between data and decisions that algorithms cannot fill? And why is understanding this chasm actually a prerequisite for making good use of AI.
date: 2017-03-03
updated: 2026-03-03
pillar: ai
tags:
...
This is the same issue as the taste problem I discussed in "[Post-Code Era Thinking: When Taste Becomes Humanity's Key Competitive Advantage](/articles/post-code-era-taste)." AI can find optimal solutions within your defined coordinate system, but defining the coordinate system itself—what is "good," what's worth pursuing, what risks are acceptable—these remain human responsibilities.
...
I further explore this issue in "[Algorithms as Judges](/articles/algorithm-as-judge)": when we let algorithms judge human worth and allocate human opportunities, what exactly are we trusting?
