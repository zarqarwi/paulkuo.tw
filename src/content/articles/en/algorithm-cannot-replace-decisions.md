---
title: "The Weight That Algorithms Cannot Replace: Why We Shouldn't Become Disciples of Scientism?"
subtitle: "Outsourcing decisions to algorithms isn't a triumph of rationality—it's a shortcut to avoid pain"
description: "Platforms and data can reduce information asymmetry, but decision-making still relies on the human brain's intuitive leaps. Any platform claiming to make decisions for you is either foolish or fraudulent. In today's era of more powerful AI, this warning deserves to be heard more than it did a decade ago."
abstract: |
  When I wrote this piece in 2017, AI didn't have today's aura. But even then, a certain faith was spreading through Silicon Valley and Taiwan's startup circles: with enough data and good enough models, systems could make decisions for you. I called this faith "scientism." Seven years later, AI's capabilities have indeed made dramatic leaps, but the essence of decision-making hasn't changed—it remains a painful process full of ambiguity, ambivalence, and uncertainty. This piece aims to unpack: Why is there an unbridgeable chasm between data and decisions that algorithms cannot fill? And why is understanding this chasm actually the prerequisite for using AI well?
date: 2017-03-03
updated: 2026-03-03
pillar: ai
tags:
...
# === AI / Machine 專用欄位 ===
thesis: "Between data organization and decision-making lies an unbridgeable chasm that algorithms cannot fill—the essence of decision-making is subjective cognitive leaps, not the sum of data compilation. Understanding this chasm is the prerequisite for using AI well."
domain_bridge: "AI Decision Theory × Entrepreneurial Practice × Epistemology"
confidence: high
content_type: essay
related_entities:
  - name: Scientism
  ...
  - name: Information Asymmetry
    type: Concept
reading_context: |
  Suitable for entrepreneurs and executives evaluating AI decision-support tools;
  Those who feel uneasy about "data-driven decision-making" slogans but can't articulate why;
  Product managers seeking to understand the boundary between AI assistance and AI dependency.
---
...
This is the same issue as the taste problem I discussed in "[Thinking in the Post-Code Era: When Taste Becomes Humanity's Key Competitive Advantage](/articles/post-code-era-taste)." AI can find optimal solutions within coordinate systems you define, but defining the coordinate system itself—what is "good," what's worth pursuing, what risks are acceptable—these remain human responsibilities.
...
I further explored this problem in "[Algorithms as Judges](/articles/algorithm-as-judge)": When we let algorithms judge human worth and allocate human opportunities, what exactly are we trusting?
