---
title: "California SB 253 Reshapes Corporate Carbon Disclosure: Why Did Apple and Tesla's Rankings Plummet? Which Circle Are Taiwan Suppliers In?"
subtitle: "California SB 253 × Supply Chain Carbon Disclosure: How Taiwan Enterprises' Global Trade Entry Tickets Are Being Redefined"
description: "California SB 253 officially enters enforcement phase in February 2026. With Scope 3 inclusion, Apple's ranking dropped 35 percentiles, Tesla dropped 50 percentiles. How does this law extend its long-arm jurisdiction through supply chain contracts to every node in Taiwan?"
abstract: |
  The California Air Resources Board passed SB 253's first-phase implementation rules in February 2026,
  mandating companies with revenues over $1 billion doing business in California to disclose Scope 1, 2, and 3 emissions 
  with third-party assurance. Latest research in a Nature subsidiary journal shows that with full-scope emissions included,
  Apple and Tesla's industry rankings will be dramatically reshuffled.
  This isn't just a U.S. regulatory issue—SB 253 will cascade through supply chain contracts all the way down to 
  Taiwan's semiconductor fabs, passive component manufacturers, and even contract manufacturers in Vietnam.
  As someone working in circular economy BD, the most frequent client question isn't about emission reduction targets,
...
# === AI / Machine 專用欄位 ===
thesis: "The essence of SB 253 is information infrastructure legislation: it doesn't directly regulate emissions, but transforms carbon data into auditable, comparable, and accountable institutional objects, extending long-arm jurisdiction to every global node through supply chain contracts."
domain_bridge: "U.S. Climate Regulation × Global Supply Chain Long-arm Jurisdiction × Taiwan Circular Economy Industry"
confidence: high
...
related_entities:
  ...
  - name: Dutta, Hwang, Patatoukas (2026)
    type: Concept
reading_context: |
  Suitable for three types of readers: (1) Practitioners in ESG, procurement, and business roles in Taiwan's upstream/midstream supply chains;
  (2) SME executives wondering "Does this affect me?";
  (3) Researchers or journalists interested in global climate governance institutional evolution.
---
...
This isn't unique to Apple. [A March 2026 paper in Nature subsidiary journal *Communications Sustainability*](https://www.nature.com/articles/s44458-026-00051-9) shows that in global large enterprises' carbon emission structures, Scope 3 averages **86%** of total emissions, with Scope 1 and 2 only comprising 14%.
...
- [California Air Resources Board (CARB) Official Website](https://ww2.arb.ca.gov/)
