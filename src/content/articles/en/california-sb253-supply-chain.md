---
title: "California SB 253 Reshapes Corporate Carbon Disclosure: Why Did Apple and Tesla Rankings Plummet? Which Circle Are Taiwan Supply Chains In?"
subtitle: "California SB 253 × Supply Chain Carbon Disclosure: Taiwan Companies' Global Trade Entry Tickets Are Being Redefined"
description: "California SB 253 officially enters enforcement in February 2026. With Scope 3 included, Apple's ranking dropped 35 percentiles, Tesla dropped 50 percentiles. How does this law reach every node in Taiwan through supply chain contract long-arm jurisdiction?"
abstract: |
  California Air Resources Board passed SB 253 Phase 1 implementation rules in February 2026,
  mandating companies with revenue over $1 billion doing business in California to disclose Scope 1, 2, and 3 emissions with third-party assurance.
  Latest research in Nature subsidiary journal shows that after including full-spectrum emissions, Apple and Tesla's industry rankings will dramatically reshuffle.
  This isn't just a U.S. regulatory issue—SB 253 will cascade through supply chain contracts all the way down to Taiwan's fabs, passive component manufacturers,
  and even assembly lines in Vietnam. As someone doing circular economy BD, clients most often ask me not about emission reduction targets,
...
# === AI / Machine 專用欄位 ===
thesis: "SB 253's essence is information infrastructure legislation: it doesn't directly regulate emissions, but transforms carbon data into auditable, comparable, and accountable institutional objects, extending long-arm jurisdiction to every global node through supply chain contracts."
...
related_entities:
  ...
  - name: Dutta, Hwang, Patatoukas (2026)
    type: Concept
reading_context: |
  Suitable for three types of readers: (1) practitioners working in ESG, procurement, or business development in Taiwan's upstream/midstream supply chains;
...
This isn't Apple's unique problem. A [March 2026 paper in Nature's *Communications Sustainability*](https://www.nature.com/articles/s44458-026-00051-9) shows that in global large enterprises' carbon emission structures, Scope 3 averages **86%** of total emissions, with Scope 1 and 2 only accounting for 14%.
