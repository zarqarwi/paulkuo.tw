...
abstract: |
  齐格蒙特·鲍曼（Zygmunt Bauman）在2000年提出「液态现代性」（Liquid Modernity）时，大多数人觉得这是学院里的理论修辞。二十年后，COVID-19用最残酷的方式证明他是对的。Paul从2020年疫情期间团队被迫全面远端化的经验出发，发现「液态」不只是社会结构的描述，更是个人生存的隐喻。那些以为稳固的——客户关系、收入来源、团队默契——在封城令下三周内全部液化。这篇文章不是怀旧，不是检讨，而是一个「带着清醒往前走」的邀请。
date: 2020-05-15
updated: 2026-03-02
pillar: life
tags:
...
疫情做的事情，不是打破了一个稳固的世界——而是撕掉了「这个世界很稳固」的错觉。
...
我们以为稳固的客户关系，其实是液态的。我们以为稳定的收入来源、以为不会改变的工作方式，其实也都是液态的。
...
不要假装世界是固态的（那是自欺），也不要因为世界是液态的就放弃所有努力（那是虚无）——而是带着「一切都可能改变」的清醒，去选择那些值得你投入的事情，即使它们也是液态的。
