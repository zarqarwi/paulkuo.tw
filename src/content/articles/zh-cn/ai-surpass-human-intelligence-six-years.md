...
而 AGI，如果它确实存在，会是一个质的转变——能自我改进、自我目标设定、真正理解人类价值观，跟在 MMLU 上多得 2% 是不同层次的事。

## 结论：等待下一个突破

我说的是：基于目前的趋势，六年的时间表过于乐观。AGI 可能会来，但不是靠这样算出来的。

AI 会继续进步。但进步可能是 S 型曲线，而不是指数曲线。我们可能已经通过了快速增长阶段，现在进入了平坦阶段。

而真正的 AGI，可能需要一个新的技术突破——也许是新的算法、新的硬件、或者对智慧本身的新的理解。

在那之前，享受 AI 在特定任务上的进步就好。别让一个测试分数，替代你对 AGI 的判断。