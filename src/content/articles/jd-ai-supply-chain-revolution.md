...
先講一個值得注意的訊號。2025 年，史丹佛商學院的供應鏈管理大師 Hau L. Lee（李效良）與柏克萊加大的沈祖鈞教授（Zuo-Jun Max Shen），把京東的 AI 供應鏈實踐寫成了正式學術論文，發表在 SSRN 上。論文用經典的「Triple-A」框架——敏捷性（Agility）、適應性（Adaptability）、對齊性（Alignment）——分析京東的三個具體案例。
