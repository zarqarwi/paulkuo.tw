...
そして、AGI（真に存在するなら）は、質的な転換だろう——自己改善でき、自分の目標を設定でき、人間の価値観を真に理解できる。MMBUで2％多くのポイントを得るのとは、次元が違う話だ。

## 結論：次のブレークスルーを待つ

言いたいのはこうだ：現在のトレンドに基づけば、6年のタイムラインは楽観的すぎる。AGIはいつか来るかもしれない——ただし、この計算では無理だ。
...
それまでは、特定タスクでのAIの進歩を享受すればいい。ベンチマークのスコアで、AGIへの判断を代替させないように。