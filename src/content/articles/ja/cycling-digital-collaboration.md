...
1つ強調したいことがある：デジタル時代の協働は、「共通善」のユートピア的想像ではなく——冷たい効率計算である。
...
そして組立の前提は、開放である。あなたは自分自身の一部をパートナーに暴露する意思がなければならず、相手が自分たちの最良の部分をあなたに暴露することを信頼しなければならない。これは技術能力ではなく、本当に開かれたマインドセットを必要とする。
