...
同じ技術で、全く異なる2つの結果。結果を決めるのは、人機インターフェースを誰が設計するかだ。
...
これは何を意味するか？責任を問われるべきは、彼らをそのように訓練したシステムだ。
...
「何が価値ある知識か」という我々の定義が、根本的に転覆されている——これは文明レベルの問題だ。
...
企業にとって、この研究が実際に語っているのは：AIを人件費削減に使うのは最も近視眼的な戦略だということである。真の効率は人機協力プロセスの再設計から生まれ、AIで各従業員の能力の上限を引き上げることから生まれる。AIで人件費を削る：一時的な節約、長期的な人材断層。人機協働フローを再設計する：組織全体のアップグレード。
