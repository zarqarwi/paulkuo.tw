...
執筆：AIは初稿を素早く生成できるが、どの観点を発展させる価値があるか、どの段落を削るべきかを判断するのは依然として人である。デザイン：AIは百のプランを産出できるが、どのプランが真にユーザーの問題を解決するかを見分けるのは依然として人である。データ分析も同様だ——AIはすべてのモデルを実行できるが、あなたが正しい問いを立てているかどうか、それだけはAIには答えられない。
...
問題はもはや「プログラムが書けるかどうか」ではなく——「どの問題を解決すべきかを知っているかどうか」である。
