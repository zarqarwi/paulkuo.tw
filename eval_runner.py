...
def translate_w(src, g, code):
    r = requests.post(f"{WORKER_URL}/translate", json={"text": src[:2000], "sourceLang": "ja", "targetLang": "zh-TW", "code": code, "glossary": g or []}, timeout=60)
    r.raise_for_status()
    return tw_post(r.json().get("translated", ""))
