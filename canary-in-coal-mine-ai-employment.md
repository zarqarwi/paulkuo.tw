...
去年秋天，一位做人資的朋友跟我吃飯時講了一件事。她們公司開了三個初階數據分析師的職缺，收到兩百多封履歷。面試到一半，主管突然說：「先暫停，我讓 Claude 跑了一下，發現這三個職位的核心產出，兩個模型加一個 Python 腳本就能處理。」
...
這讓我想到在 SDTI 的經驗。我們導入 AI 輔助分析貴金屬回收流程時，一開始也面臨同樣的選擇：是讓 AI 直接接管品質判定，還是讓它成為現場工程師的即時參考工具？我們選了後者。不是因為技術做不到前者，而是因為回收現場的變數——酸液濃度的微妙變化、板材成分的批次差異——需要人的經驗來做最後一層過濾。

結果是，資淺的工程師反而成長最快。因為他們不再需要花三年才能累積的「直覺」，AI 把那些模式辨識的部分先墊高了，他們可以更快進入「判斷」的層次。
...
對教育體系——這是最沉重的警鐘。當你的畢業生進入職場的第一天，就發現自己四年學的東西已經被一個 API 取代，這不是學生的問題。這是整個知識傳遞體系的結構性失敗。
