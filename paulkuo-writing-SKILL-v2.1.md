...
3. L2 成稿查證 + 引用 spot check → Paul 確認
4. 封面圖生成（見「封面圖生成」章節）
5. 內文配圖（如需要，Visualizer 生成或截圖）
6. 多語言翻譯 en / ja / zh-cn（見「多語言翻譯管線」章節）
7. 品質檢查清單全過
...
| circular-economy | 深綠 | 翡翠綠 #059669 / 大地色 | 循環箭頭、材料流、綠色工業 |
